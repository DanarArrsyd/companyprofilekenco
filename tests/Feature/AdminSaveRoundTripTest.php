...
dataset('edit forms', [
    'capability' => [fn () => tap(Capability::factory()->published()->create(['featured_image' => 'library/cap.webp', 'icon' => 'cog']), 'seedSeo'), 'capabilities', 'capability',
        fn (array $r) => ['name' => $r['name'], 'summary' => $r['summary'] ?? '', 'description' => $r['description'] ?? '', 'icon' => $r['icon'] ?? '', 'featured_image_path' => $r['featured_image'] ?? '', 'is_featured' => $r['is_featured'], 'sort_order' => $r['sort_order'], 'status' => $r['status'], 'published_at' => formDate($r['published_at']), 'seo' => formSeo($r['seo_metadata']), 'translations' => ['id' => $r['translations']['id'] ?? []]]],
    'article' => [fn () => tap(Article::factory()->published()->create(['featured_image' => 'library/news.webp']), 'seedSeo'), 'news', 'article',
        fn (array $r) => ['title' => $r['title'], 'excerpt' => $r['excerpt'] ?? '', 'content' => $r['content'] ?? '', 'news_category_id' => $r['news_category_id'] ?? '', 'featured_image_path' => $r['featured_image'] ?? '', 'is_featured' => $r['is_featured'], 'status' => $r['status'], 'published_at' => formDate($r['published_at']), 'seo' => formSeo($r['seo_metadata']), 'translations' => ['id' => $r['translations']['id'] ?? []]]],
    ...
    'facility' => [fn () => Facility::factory()->published()->create(['image' => 'library/facility.webp']), 'facilities', 'facility',
        fn (array $r) => ['name' => $r['name'], 'location' => $r['location'] ?? '', 'description' => $r['description'] ?? '', 'facility_category_id' => $r['facility_category_id'] ?? '', 'image_path' => $r['image'] ?? '', 'sort_order' => $r['sort_order'], 'status' => $r['status'], 'published_at' => formDate($r['published_at']), 'translations' => ['id' => $r['translations']['id'] ?? []]]],
    'industry' => [fn () => Industry::factory()->published()->create(['image' => 'library/industry.webp']), 'industries', 'industry',
        fn (array $r) => ['name' => $r['name'], 'description' => $r['description'] ?? '', 'image_path' => $r['image'] ?? '', 'sort_order' => $r['sort_order'], 'status' => $r['status'], 'published_at' => formDate($r['published_at']), 'translations' => ['id' => $r['translations']['id'] ?? []]]],
    'quality content' => [fn () => QualityContent::factory()->published()->create(['image' => 'library/quality.webp']), 'quality-content', 'item',
        fn (array $r) => ['title' => $r['title'], 'summary' => $r['summary'] ?? '', 'content' => $r['content'] ?? '', 'image_path' => $r['image'] ?? '', 'sort_order' => $r['sort_order'], 'status' => $r['status'], 'published_at' => formDate($r['published_at']), 'translations' => ['id' => $r['translations']['id'] ?? []]]],
