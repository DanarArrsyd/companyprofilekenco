            ...
            <form onSubmit={submit} className="rounded-lg border border-border bg-surface px-6 sm:px-8">
                ...
                <FormSection title="General">
                    <div>
                        ...
                        <Input id="name" {...bind('name', fieldHelp('facility-categories', 'name').example)} className="mt-1.5" autoFocus />
                    ...
                    <div>
                        ...
                        <FieldHint id="slug-help">{fieldHelp('facility-categories', 'slug').hint}</FieldHint>
                ...
                <FormSection title="Display" description="Ordering and visibility.">
                    <div>
                        ...
                        <FieldHint id="sort_order-help">{fieldHelp('facility-categories', 'sort_order').hint}</FieldHint>
                    </div>
                    <div>
                        ...
                        <FieldHint id="status-help">{fieldHelp('facility-categories', 'status').hint}</FieldHint>
                    </div>
                </FormSection>
