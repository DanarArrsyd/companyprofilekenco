        ...
        <PublicLayout>
            ...
            <section className="border-b border-border">
                <div className="mx-auto max-w-content px-5 py-16 sm:px-6 lg:px-8">
                    <SectionHeader
                        ...
                        description="Our quality certifications and accreditations, kept current."
                    />
                </div>
            </section>
            ...
            <div className="mx-auto max-w-content px-5 py-12 sm:px-6 lg:px-8">
                {certifications.length === 0 ? (
                    <p className="text-small text-muted-foreground">No certifications published yet.</p>
                ) : showGrouped ? (
                    <div className="space-y-12">
                        <div>
                            <h2 className="text-caption uppercase text-muted-foreground">Active</h2>
                            <div className="mt-2">
                                <CertificationItem items={active} variant="detailed" />
                            </div>
                        </div>
                        <div>
                            <h2 className="text-caption uppercase text-muted-foreground">Expired</h2>
                            <div className="mt-2">
